...
courtColumn: (court: string) => `xpath=//div[contains(@class,'court') or contains(@class,'pista') or contains(@class,'col')][.//text()[contains(.,"${court}")]]`,
slotButton: (time: string) => `xpath=//button[contains(.,"${time}") or contains(@aria-label,"${time}")] | //a[contains(.,"${time}")]`,
...
bookingRow: (dateISO: string) => `tr:has-text("${dateISO}")`
},
feedback: {
